...
def main():
    ...
    try:
        ...
        print("Please install OpenCV, NumPy, and scikit-learn:")
        print("pip install opencv-python numpy pillow scikit-learn")
        return

    # HARD CODE YOUR ROOT FOLDER PATH HERE:
    root_folder = "/media/general-max-riekeles/MMT_3/ME/Analysis_20_09/segmentation_output/Copper_3"  # Replace with your actual path
